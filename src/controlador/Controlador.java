...
public class Controlador {
	...
	/**
	 * Verifica el login y el password ingresado, si son incorrecto lanza un
	 * LoginException
	 * 
	 * Si el password tiene mas de x días lanza un CambioPasswordException indicando
	 * que la password está vencida
	 * 
	...
	public ProductoView altaProducto(ProductoView recibido) throws RubroException, SubRubroException {
		...
		Producto producto = new Producto(auxSR, auxR, recibido.getNombre(), recibido.getMarca(),
				recibido.getCodigoBarras(), recibido.getPrecio());
		producto.save();
	...
	/* Probado */
	public ItemPedidoView agregarProductoEnPedido(int numeroPedido, int identificadorProducto, int cantidad)
